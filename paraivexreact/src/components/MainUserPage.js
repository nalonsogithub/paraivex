...
//			console.log("Fetching user documents for user:", auth.username);  // Log the username
	...
	// Log whenever brains or configurations are updated
//	useEffect(() => {
//		console.log("Updated Brains in MainUserPage:", brains);
//	}, [brains]);
//
//	useEffect(() => {
//		console.log("Updated Configurations in MainUserPage:", configurations);
//	}, [configurations]);
